...
setup(
    ...
    package_data={'': ['internal/test/data/env_train/env_train_cr_192.csv',
                       'internal/test/data/env_train/env_train_cr_192_metadata.csv',
                       'internal/test/outputs/holdout_192.csv']},
